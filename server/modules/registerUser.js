                        ...
                        transporter.sendMail(mailOptions, function (error, info) {
                            if (error) {
                                res.json({
                                    ...
                                    message: 'there was an error sending a verification email, please try again' 
                                })
                            } else {
                               user.save((err, doc)=>{
                                   res.json({
